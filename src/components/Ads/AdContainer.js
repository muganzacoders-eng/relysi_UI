// // // frontend/src/components/ads/AdContainer.js
...
// // function AdContainer({ position = 'sidebar_right', adType = 'sidebar' }) {
...
// //       const targetAudience = user?.role || 'all';
...
// //       const fetchedAds = await advertisementService.getAdvertisements(filters);
// //       setAds(fetchedAds);
// //     } catch (error) {
...
// //   // Limit number of ads based on position
...
// //     <Box sx={{ width: '100%' }}>
// //       {displayAds.map((ad) => (
// //         <Advertisement key={ad.ad_id} ad={ad} variant={adType} />
// //       ))}
// //     </Box>
// //   );
// // }
...
// //     'content_bottom'
// //   ]),
// //   adType: PropTypes.oneOf(['banner', 'sidebar', 'popup', 'footer'])
// // };
